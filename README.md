...
```text
Phase 1: Sequential global-memory baseline       DONE
Phase 2: Coalescing study                         DONE
Phase 3: Shared-memory study                      DONE
Phase 4: Polish, CLI, profiling, documentation    IN PROGRESS
```
